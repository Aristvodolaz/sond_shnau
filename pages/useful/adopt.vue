    ...
    <div class="container-custom max-w-4xl py-8 md:py-10">
      ...
      <UiCard class="mb-8">
        ...
        <div ref="questionnaireRef" class="bg-warm-100 rounded-lg p-6 text-sm font-mono text-warm-800 space-y-2 max-h-96 overflow-y-auto">
          ...
          <p>1. Ваше ФИО</p>
          <p>2. Дата вашего рождения</p>
          <p>3. Город, населенный пункт, в котором вы проживаете</p>
          <p>4. Есть ли в семье дети? Возраст детей</p>
          <p>5. Есть ли в семье другие животные? Какие животные?</p>
          <p>6. Есть ли у вас опыт содержания собак? Опишите, пожалуйста, какие собаки у вас были и с какими сложностями воспитания вы столкнулись.</p>
          <p>7. Сколько всего членов семьи проживают с вами?</p>
          <p>8. Есть ли среди них аллергики?</p>
          <p>9. С кем будет находиться собака во время вашего отпуска(болезни)?</p>
          <p>10. Какой вид кормления планируете обеспечить собаке? (сухой корм суперпремиумкласса, натуральное питание).</p>
          <p>11. Готовы ли вы к трудностям адаптации собаки в вашей семье?</p>
          <p>12. Готовы ли при необходимости работать с кинологом?</p>
          <p>13. Какого пола вы хотели бы собаку?</p>
          <p>14. Желаемый возраст собаки</p>
          <p>15. Если вы кого-то из подопечных Фонда уже выбрали, укажите, пожалуйста, кличку</p>
          <p>16. По какой причине вы хотите завести собаку?</p>
          <p>17. Укажите, пожалуйста, условия вашего проживания:</p>
          <p>18. Ваши контакты:</p>
        </div>
